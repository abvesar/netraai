...
class DrishtiAIDMS:
    ...
    def process_frame(self, frame):
        ...
        status = {"drowsy": False, "distracted": False, "yawning": False, "face_recognized": False, "driver_id": "DRIVER NOT RECOGNIZED", "fatigue_score": 0.0, "ear": 0.0, "mar": 0.0, "yaw": 0.0, "face_detected": bool(results.multi_face_landmarks)}
        ...
        status["edge_ai"] = EdgeAIClassifier().classify(drowsy=status["drowsy"], distracted=status["distracted"], yawning=status["yawning"])
        return status
